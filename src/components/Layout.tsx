...
import { IconAlertCircle, IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMenu2, IconSquareCheck } from '@tabler/icons-react';
...
const APP_TITLE = 'Gartenpflege-Manager';
...
const navigation = [
  ...
  { name: 'Pflegeplanung', href: '/pflegeplanung', icon: IconFileText },
  { name: 'Gartenbereiche', href: '/gartenbereiche', icon: IconFileText },
  { name: 'Arbeitsprotokoll', href: '/arbeitsprotokoll', icon: IconFileText },
  { name: 'Saisonale Aufgaben', href: '/saisonale-aufgaben', icon: IconSquareCheck },
];

const externalNavigation = [
  { name: 'Pflegeplanung', href: '/gateway/apps/69ac68506c4047109f2ef1b3?template=list_page', icon: IconFileText },
  { name: 'Gartenbereiche', href: '/gateway/apps/69ac684a7a71d66a8bcf9a19?template=list_page', icon: IconFileText },
  { name: 'Arbeitsprotokoll', href: '/gateway/apps/69ac6850bdf7c76fbace388c?template=list_page', icon: IconFileText },
  { name: 'Saisonale Aufgaben', href: '/gateway/apps/69ac684f4e04afa6767a4c6e?template=list_page', icon: IconSquareCheck },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69ac68506c4047109f2ef1b3?template=list_page"
